...
namespace NucleusRH.Base.Personal.InterfaceLicencias
{
    public partial class LICENCIAS : Nomad.NSystem.Base.NomadObject
    {
        public static void ImportarLicencias()
        {
            ...
            NucleusRH.Base.Personal.InterfaceLicencias.LICENCIAS objRead;
            ...
            for (Linea = 1, IDCur = IDList.FindElement("ROWS").FirstChild(); IDCur != null; IDCur = IDCur.Next(), Linea++)
            {
                ...
                objRead = NucleusRH.Base.Personal.InterfaceLicencias.LICENCIAS.Get(IDCur.GetAttr("id"));
