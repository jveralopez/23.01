...
namespace NucleusRH.Base.Tiempos_Trabajados.GAFInterfaceFichadas
{
  ...
  //Clase FichadasIngresadas
    public partial class FICHADASING : Nomad.NSystem.Base.NomadObject
    {
        ...
        {
            NomadBatch b = NomadBatch.GetBatch("Importar Fichadas GAF", "Importar Fichadas GAF");
            ...
            NucleusRH.Base.Tiempos_Trabajados.GAFInterfaceFichadas.FICHADASING intFichIng;
