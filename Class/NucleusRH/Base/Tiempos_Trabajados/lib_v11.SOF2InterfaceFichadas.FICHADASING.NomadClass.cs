...
namespace NucleusRH.Base.Tiempos_Trabajados.SOF2InterfaceFichadas
{
    //////////////////////////////////////////////////////////////////////////////////
    ...
    public partial class FICHADASING : Nomad.NSystem.Base.NomadObject
    {
        ...
        {
            //Codigo en .NET
            NomadBatch b = NomadBatch.GetBatch("Importar Fichadas SOFI2", "Importar Fichadas SOFI2");
            ...
            NucleusRH.Base.Tiempos_Trabajados.SOF2InterfaceFichadas.FICHADASING intFichIng;
            ...
            for (linea = 1, MyROW = MyXML.FirstChild().FirstChild(); MyROW != null; linea++, MyROW = MyROW.Next())
            {
                ...
                try
                {
                    ...
                    ddoFichIng.f_fechahora = Convert.ToDateTime(intFichIng.fechaHora);
                    ...
                    //TIPO - Evento no definido

                    //TIPO
                    lasssecc = "asignando evento INDEFINIDO";
