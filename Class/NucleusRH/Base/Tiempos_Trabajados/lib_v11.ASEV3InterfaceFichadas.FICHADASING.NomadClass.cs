...
namespace NucleusRH.Base.Tiempos_Trabajados.ASEV3InterfaceFichadas
{
    //////////////////////////////////////////////////////////////////////////////////
    ...
    public partial class FICHADASING : Nomad.NSystem.Base.NomadObject
    {
        ...
        {
            //Codigo en .NET
            NomadBatch b = NomadBatch.GetBatch("Importar Fichadas ASEV3", "Importar Fichadas ASEV3");
            ...
            NucleusRH.Base.Tiempos_Trabajados.ASEV3InterfaceFichadas.FICHADASING intFichIng;
