...
namespace NucleusRH.Base.Tiempos_Trabajados.ASEV2InterfaceFichadas
{
    //////////////////////////////////////////////////////////////////////////////////
    ...
    public partial class FICHADASING : Nomad.NSystem.Base.NomadObject
    {
        public static void ImportarFichadas(int oi_terminal)
        {
            ...
            NucleusRH.Base.Tiempos_Trabajados.ASEV2InterfaceFichadas.FICHADASING intFichIng;

            //ILT-2017.06.12
            string eventsIN = "00;20"; //Eventos de tipo Entrada
            string eventsOUT = "01;22"; //Eventos de tipo Salida
            ...
            for (linea = 1, MyROW = MyXML.FirstChild().FirstChild(); MyROW != null; linea++, MyROW = MyROW.Next())
            {
                ...
                try
                {
                    ...
                    System.DateTime FH = new System.DateTime(F.Year, F.Month, F.Day, H.Hour, H.Minute, H.Second);
