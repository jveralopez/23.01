...
namespace NucleusRH.Base.Tiempos_Trabajados.CSVRInterfaceFichadas
{
    ...
    public partial class FICHADASING : Nomad.NSystem.Base.NomadObject
    {
        ...
        {
            //Codigo en .NET
            NomadBatch b = NomadBatch.GetBatch("Importar Fichadas CSVR", "Importar Fichadas CSVR");
            ...
            NucleusRH.Base.Tiempos_Trabajados.CSVRInterfaceFichadas.FICHADASING intFichIng;
