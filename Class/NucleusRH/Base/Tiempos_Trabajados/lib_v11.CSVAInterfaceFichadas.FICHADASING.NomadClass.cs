...
namespace NucleusRH.Base.Tiempos_Trabajados.CSVAInterfaceFichadas 
{
  ...
  //Clase FichadasIngresadas
    public partial class FICHADASING : Nomad.NSystem.Base.NomadObject
    {
        ...
        {
            //Codigo en .NET
            NomadBatch b = NomadBatch.GetBatch("Importar Fichadas CSVA", "Importar Fichadas CSVA");
            ...
            NucleusRH.Base.Tiempos_Trabajados.CSVAInterfaceFichadas.FICHADASING intFichIng;
