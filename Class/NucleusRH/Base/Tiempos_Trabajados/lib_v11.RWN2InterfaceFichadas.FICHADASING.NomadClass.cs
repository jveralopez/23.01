...
namespace NucleusRH.Base.Tiempos_Trabajados.RWN2InterfaceFichadas
{
    ...
    public partial class FICHADASING : Nomad.NSystem.Base.NomadObject
    {
        ...
        {
            //Codigo en .NET
            NomadBatch b = NomadBatch.GetBatch("Importar Fichadas RWN2", "Importar Fichadas RWN2");
            ...
            NucleusRH.Base.Tiempos_Trabajados.RWN2InterfaceFichadas.FICHADASING intFichIng;
