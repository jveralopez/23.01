...
namespace NucleusRH.Base.Tiempos_Trabajados.SOFInterfaceFichadas
{
    //////////////////////////////////////////////////////////////////////////////////
    ...
    public partial class FICHADASING : Nomad.NSystem.Base.NomadObject
    {
        ...
        {
            //Codigo en .NET
            NomadBatch b = NomadBatch.GetBatch("Importar Fichadas SOFI", "Importar Fichadas SOFI");
            ...
            NucleusRH.Base.Tiempos_Trabajados.SOFInterfaceFichadas.FICHADASING intFichIng;
            ...
            for (linea = 1, MyROW = MyXML.FirstChild().FirstChild(); MyROW != null; linea++, MyROW = MyROW.Next())
            {
                ...
                try
                {
                    ...
                    System.DateTime F = intFichIng.fechaHora;
