...
namespace NucleusRH.Base.Tiempos_Trabajados.ASEGOInterfaceFichadas
{
    //////////////////////////////////////////////////////////////////////////////////
    ...
    public partial class FICHADASING : Nomad.NSystem.Base.NomadObject
    {
        ...
        {
            //Codigo en .NET
            NomadBatch b = NomadBatch.GetBatch("Importar Fichadas ASEGO", "Importar Fichadas ASEGO");
            ...
            NucleusRH.Base.Tiempos_Trabajados.ASEGOInterfaceFichadas.FICHADASING intFichIng;
