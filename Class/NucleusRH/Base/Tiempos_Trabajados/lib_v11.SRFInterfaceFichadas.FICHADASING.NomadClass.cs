...
namespace NucleusRH.Base.Tiempos_Trabajados.SRFInterfaceFichadas
{
    ...
    public partial class FICHADASING : Nomad.NSystem.Base.NomadObject
    {
        ...
        {
            //Codigo en .NET
            NomadBatch b = NomadBatch.GetBatch("Importar Fichadas SRF", "Importar Fichadas SRF");
            ...
            NucleusRH.Base.Tiempos_Trabajados.SRFInterfaceFichadas.FICHADASING intFichIng;
