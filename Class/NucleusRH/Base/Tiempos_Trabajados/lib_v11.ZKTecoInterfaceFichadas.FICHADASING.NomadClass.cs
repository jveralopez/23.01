...
namespace NucleusRH.Base.Tiempos_Trabajados.ZKTecoInterfaceFichadas 
{
  ...
  //Clase FichadasIngresadas
    public partial class FICHADASING : Nomad.NSystem.Base.NomadObject
    {
        ...
        {
            NomadBatch b = NomadBatch.GetBatch("Importar Fichadas ZKE9", "Importar Fichadas ZKE9");
            ...
            NucleusRH.Base.Tiempos_Trabajados.ZKTecoInterfaceFichadas.FICHADASING intFichIng;
