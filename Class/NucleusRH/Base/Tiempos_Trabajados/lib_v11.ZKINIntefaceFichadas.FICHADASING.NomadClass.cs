...
namespace NucleusRH.Base.Tiempos_Trabajados.ZKINInterfaceFichadas
{
    ...
    public partial class FICHADASING : Nomad.NSystem.Base.NomadObject
    {
        ...
        {
            //Codigo en .NET
            NomadBatch b = NomadBatch.GetBatch("Incorporar Fichadas ZK IN...", "Incorporar Fichadas ZK IN...");
            ...
            //ILT-2017.06.12
            string eventsIN = "Entrada;OT Entrada"; //Eventos de tipo Entrada            
            string eventsOUT = "Salida;OT Salida;Vuelve a Salir"; //Eventos de tipo Salida
            ...
            for (linea = 1, MyROW = MyXML.FirstChild(); MyROW != null; linea++, MyROW = MyROW.Next())
            {
                ...
                try
                {
                    ...
                    param.SetAttr("c_terminal", intFichIng.terminal);
                    terminal = NomadEnvironment.QueryNomadXML(NucleusRH.Base.Tiempos_Trabajados.ZKINInterfaceFichadas.FICHADASING.Resources.QRY_TERMINAL, param.ToString());
                    ddoFichIng.oi_terminal = terminal.FirstChild().FirstChild().GetAttr("oi_terminal");
