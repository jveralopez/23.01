...
namespace NucleusRH.Base.Tiempos_Trabajados.ARSEMETInterfaceFichadas
{
    //////////////////////////////////////////////////////////////////////////////////
    ...
    public partial class FICHADASING : Nomad.NSystem.Base.NomadObject
    {
        ...
        {
            //Codigo en .NET
            NomadBatch b = NomadBatch.GetBatch("Importar Fichadas ASE", "Importar Fichadas ASE");
            ...
            NucleusRH.Base.Tiempos_Trabajados.ARSEMETInterfaceFichadas.FICHADASING intFichIng;

            //ILT-2017.06.12
            string eventsIN = "128;129"; //Eventos de tipo Entrada            
            string eventsOUT = "130"; //Eventos de tipo Salida
