...
namespace NucleusRH.Base.Tiempos_Trabajados.CSVCInterfaceFichadas
{
    ...
    public partial class FICHADASING : Nomad.NSystem.Base.NomadObject
    {
        ...
        {
            NomadBatch b = NomadBatch.GetBatch("Importar Fichadas CSVC", "Importar Fichadas CSVC");
            ...
            NucleusRH.Base.Tiempos_Trabajados.CSVCInterfaceFichadas.FICHADASING intFichIng;
            ...
            //ILT-2017.06.21
            string eventsIN = "E;0"; //Eventos de tipo Entrada
            string eventsOUT = "S;1"; //Eventos de tipo Salida
            ...
            for (linea = 1, MyROW = MyXML.FirstChild().FirstChild(); MyROW != null; linea++, MyROW = MyROW.Next())
            {
                ...
                try
                {
                    ...
                    if (IOValidator.IsInput(intFichIng.tipo.ToUpper()))
                    {
                        ddoFichIng.l_entrada = true;
                        ddoFichIng.c_fichadasing += "AE";
                        ddoFichIng.c_tipo = "E";
                    }
                    else if (IOValidator.IsOutput(intFichIng.tipo.ToUpper()))
                    {
                    ...
                    /*//ILT-2017.06.21
                    lasssecc = "asignando evento";
                    switch (intFichIng.tipo.ToUpper())
                    {
                        case "E":
                            //ENTRADA
                                ddoFichIng.l_entrada = true;
