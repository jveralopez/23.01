...
using NucleusRH.Base.Liquidacion.InterfaceVariablesFijasUnica;
using NucleusRH.Base.Liquidacion.Legajo_Liquidacion;

namespace NucleusRH.Base.Liquidacion_VarFijaUnica

{
    ...
    class clsImportarVariables
    {
        ...
        public void ImportarVariablesPersona(string pstoi_empresa, string str_C_Vaviable)
        {
