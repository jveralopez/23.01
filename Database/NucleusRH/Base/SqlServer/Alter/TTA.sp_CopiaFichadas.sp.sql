if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[sp_CopiaFichadas]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[sp_CopiaFichadas]
GO
...
CREATE     procedure dbo.sp_CopiaFichadas 
...
BEGIN
	...
	print 'insertando ' + convert(varchar, @oi_Fichada)
